...
| `/time` | Get current time in multiple cities. | **Not accepted.** |
...
| `/wiki` | Searches the wiki for a matching page.<br>*(Powered by [Fandom.com](https://genshin-impact.fandom.com/))* | **Needed.** |
