...
| `/resin`<br>`/res` | Resin tracker for Genshin Impact. | **Not needed, but accepted.**<br>`/resin 40` will set your current resin value to 40.<br>`/resin` will return your current resin value, as well as when your resin is expected to be filled completely. |
